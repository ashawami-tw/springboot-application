...
public class UserDtoTest {
    ...
    public void testEmptyEmail() {
        ...
        assertThat(constraintViolations.iterator().next().getMessage()).isEqualTo(Message.INVALID_EMAIL);
    }
    ...
    public void testEmptyPassword() {
        ...
        assertThat(constraintViolations.size()).isEqualTo(1);
        assertThat(constraintViolations.iterator().next().getMessage()).isEqualTo(Message.INVALID_PASSWORD);
    }
